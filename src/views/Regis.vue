...
<script lang="ts">
  ...
  export default class Regis extends Vue {
    ...
    public checkPhone = (rule: never, value: string, callback: (arg0?: Error) => void) => {
    ...
    public checkEmail = (rule: never, value: string, callback: (arg0?: Error) => void) => {
    ...
    public checkPin = (rule: never, value: string, callback: (arg0?: Error) => void) => {
      const pinReg = /[\s\S]{6,}/;
      if (!value) {
