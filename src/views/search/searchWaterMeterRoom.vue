<template>
  <div class="page">
    ...
    >
      ...
      <el-table-column align="center" width="100px" prop="watermeterLocation" label="水表位置">
      </el-table-column>
      ...
      <el-table-column align="center" prop="numberNoHouseholds" width="100px" label="非居民户数">
      </el-table-column>
      <el-table-column
        align="center"
      ...
      <el-table-column align="center" prop="pipe" width="120px" label="管材"> </el-table-column>
      <el-table-column
        align="center"
...
<script lang="ts">
  ...
  export default class SearchAll extends Vue {
    ...
    public async updateRepair(): Promise<void> {
      ...
      const res = await this["axios"].post(`WaterMeterRoom/updateWaterMeterRoomRepairInfoWithId`, {
        id: this.repairId,
